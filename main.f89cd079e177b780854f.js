!(function(e) {
	...
	function(e) {
		e.exports = JSON.parse(
			'[{"name":"Lavasciuga-Bold","selector":"lavasciuga-bold","style":"bold"}]'
		);
	},
	function(e, t, n) {
		!(function() {
					...
					if (
						...
						!(function(e) {
							...
							(E.dir = "ltr"),
								...
								o(u, h(i, '"' + i.family + '",sans-serif')),
								r(m, function(e) {
									(y = e), c();
								}),
								o(m, h(i, '"' + i.family + '",serif')),
								r(p, function(e) {
									(g = e), c();
								}),
								o(p, h(i, '"' + i.family + '",monospace'));
						});
				});
			}),
				(e.exports = a);
	...
	function(e, t, n) {
		...
		var o = n(0),
			i = n(1),
			r = n.n(i);
		const a = o.map(e => e.selector);
		let s = [];
		for (const e of o) {
			const t = new r.a(e.name);
			s.push(t.load(null, 5e3));
		}
		Promise.all(s).then(
			() => {
		...
		const c = document.querySelectorAll(".interactive-controls");
		for (const e of c) {
			const t = e.querySelector(".interactive-controls-text"),
				n = e.querySelector(".interactive-controls-styles"),
				o = e.querySelectorAll(".interactive-controls-slider"),
				i = e.querySelector(".interactive-controls-instances"),
				r = (e, n) => {
			...
			const s = e.querySelector(".interactive-controls-buttons"),
				c = s.querySelectorAll("button");
			for (const e of c)
		...
		if ("IntersectionObserver" in window) {
			...
			document.querySelectorAll(".am-i-in-view").forEach(t => {
				e.observe(t);
			});
		}
		const l = document.querySelector(".character-grid"),
			d = document.querySelector(".character-grid-zoom"),
			u = document.querySelector(".character-grid-toggle");
		(l.onmousemove = ((e, t) => {
			let n, o;
			return function i() {
				const r = Date.now();
				...
				!n || r - n >= t
					? (e.apply(null, s), (n = r))
					: (o = setTimeout(i.bind(null, ...s), t - (r - n)));
			};
		})(e => {
			"LI" === e.target.tagName && (d.innerHTML = e.target.innerHTML);
		}, 100)),
			u &&
				(u.onchange = e => {
					l.classList.remove(...a), l.classList.add(e.target.value);
				});
	},
	function(e, t, n) {
		var o;
		(o = n(5)).keys().forEach(o);
	},
	function(e, t) {
		function n(e) {
